...
SPREAD_CANDIDATE_MULT = 20    # 15×20 = 300 ≥ KRW 전체(270) → 사실상 전수 스캔
...
#
# 감수하는 대가(운영자가 인지하고 받아들인 비용, 누락이 아니다): UNIVERSE_TOP_N=15 는 유한하고
# 신규 상장 코인은 거래대금 순위 최상단에 오므로, 상장 10~365일 종목이 15칸을 두고 경쟁하며
# **기존 검증 종목이 밀려날 수 있다**.
MIN_LISTING_DAYS = 10
